...
describe('Dashboard', function(){
  ...
  .should('contain','Automation testing'); // Replace with the expected text
     ...
     const FavouriteButton= '//*[@id="root"]/div[3]/div/main/div[2]/div/div[2]/div/div[1]/table/tbody/tr[1]/td[4]/span/div'; 

     cy.xpath(FavouriteButton).should('not.have.class','active');

     cy.xpath(FavouriteButton).scrollIntoView().click();


    

     cy.xpath(FavouriteButton).should('have.class', 'active')
