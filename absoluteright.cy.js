...
cy.xpath('//*[@id="root"]/div[3]/header/div/header/div/div/ul/li[1]/span').contains('الصفحة الرئيسية'); 
...
//Verify language is changed 
cy.xpath('//*[@id="root"]/div[3]/header/div/header/div/div/ul/li[1]/span').contains('Home')
